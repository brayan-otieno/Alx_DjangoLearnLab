...
urlpatterns = [
    ...
    path('books/<int:book_id>/edit/', views.edit_book, name='edit_book'),  # Edit book
    path('books/<int:book_id>/delete/', views.delete_book, name='delete_book'),  # Delete book

    # Library Detail View (CBV)
    path('library/<int:pk>/', views.LibraryDetailView.as_view(), name='library_detail'),

    # Role-Based Views (Admin, Librarian, Member)
